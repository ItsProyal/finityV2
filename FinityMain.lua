...
function FinityV2.require(Path)
    if type(Path) == "string" then
		if FinityV2.DeveloperMode then
			...
			Path = Path:gsub("\\", "/")
			return loadstring(game:HttpGet("https://raw.githubusercontent.com/ItsProyal/finityV2/master/"..Path, true))()
		end
	end
end
...
function FinityV2.create(Object)
    if type(Object) == "string" then
		if FinityV2.DeveloperMode then
			...
			Object = Object:gsub("\\", "/")
			return loadstring(game:HttpGet("https://raw.githubusercontent.com/ItsProyal/finityV2/master/Objects/"..Object..".lua", true))()()
		end
	end
end
